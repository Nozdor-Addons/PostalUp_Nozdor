...
local Postalup_Wire = Postalup:NewModule("Wireup", "AceHook-3.0")
local L = LibStub("AceLocale-3.0"):GetLocale("Postalup")
Postalup_Wire.description = L["Set subject field to value of coins sent if subject is blank."]
