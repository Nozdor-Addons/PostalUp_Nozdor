...
local L = AL3:NewLocale("Postalup", "enUS", true, debug)
if L then
...
|cFFFFCC00*|r It will also autocomplete all names in your BlackBookup.]=] ] = true
L["Choose"] = true
L["Clear list"] = true
L["Collected"] = true
L["Contacts"] = true
...
L["Part %d"] = true
L["Please post bugs or suggestions at the wowace forums thread at |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. When posting bugs, indicate your locale and Postalup's version number v%s."] = true
...
L["TradeBlockup"] = true
L["Use Postalup's auto-complete"] = true
L["Verbose mode"] = true
L["Wireup"] = true
...
local L = AL3:NewLocale("Postalup", "deDE")
if L then
...
L["Allows you to copy the contents of a mail."] = "Erlaubt dir die Inhalte einer Nachricht zu kopieren." -- Needs review
L["Alts"] = "Twinks"
...
|cFFFFCC00*|r Deaktiviere den ausführlichen Modus um den Chatspam beim Öffnen von Post abzustellen.]=]
L[ [=[|cFFFFCC00*|r This module will list your contacts, friends, guild mates, alts and track the last 10 people you mailed.
|cFFFFCC00*|r It will also autocomplete all names in your BlackBookup.]=] ] = [=[|cFFFFCC00*|r Dieses Modul zeigt eine Liste deiner Kontakte, Freunde, Gildenmitglieder und Alts und merkt sich die letzten 10 Empfänger gesendeter Nachrichten.
...
L["DoNotWantup"] = "WirdNichtBenötigt"
...
L["Part %d"] = "Teil %d"
L["Please post bugs or suggestions at the wowace forums thread at |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. When posting bugs, indicate your locale and Postalup's version number v%s."] = "Bitte melde Fehler oder Anregungen im Wowace-Forumsthread unter |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. Wenn du Fehler meldest, gebe bitte deine Sprache und Postalups Versionsnummer v%s an."
...
L["TradeBlockup"] = "Handelsblock"
L["Use Postalup's auto-complete"] = "Postalup's autom. Vervollständigung verwenden"
...
local L = AL3:NewLocale("Postalup", "esES") or AL3:NewLocale("Postalup", "esMX")
if L then
...
L["CarbonCopyup"] = "CopiaCarboncillo"
...
|cFFFFCC00*|r Disable the Verbose option to stop the chat spam while opening mail.]=] ]==]
L[ [=[|cFFFFCC00*|r This module will list your contacts, friends, guild mates, alts and track the last 10 people you mailed.
|cFFFFCC00*|r It will also autocomplete all names in your BlackBookup.]=] ] = [=[|cFFFFCC00*|r Este modulo te mostrara tus contactos, amigos, compañeros de hermandad, alters y listara los ultimas 10 personas a las que tu mandaste un correo.
...
L["Part %d"] = "Parte %d"
L["Please post bugs or suggestions at the wowace forums thread at |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. When posting bugs, indicate your locale and Postalup's version number v%s."] = "Por favor, informe de fallos o sugerencias en el hilo del foro de wowace en |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. Al publicar errores, indique su localización y el número de versión de Postalup v %s."
...
L["TradeBlockup"] = "Bloquear Comercio"
L["Use Postalup's auto-complete"] = "Usar el auto completar de Postalup"
...
local L = AL3:NewLocale("Postalup", "frFR")
if L then
...
|cFFFFCC00*|r Selectup ne supprimera jamais un seul courrier (les courriers sans texte sont automatiquement supprimés par le jeu quand tous les objets joints et tout l'argent ont été pris).
|cFFFFCC00*|r Selectup n'ouvrira pas les couriers C.R. ainsi que ceux provenant de Blizzard.
...
|cFFFFCC00*|r OpenAllup ne supprimera jamais un seul courrier (les courriers sans texte sont automatiquement supprimés par le jeu quand tous les objets joints et tout l'argent ont été pris).
|cFFFFCC00*|r OpenAllup n'ouvrira pas les couriers C.R. ainsi que ceux provenant de Blizzard.
|cFFFFCC00*|r Désactiver l'option Verbose pour enlever le spam de la fenêtre de discussion pendant l'ouverture du courrier.]=]
L[ [=[|cFFFFCC00*|r This module will list your contacts, friends, guild mates, alts and track the last 10 people you mailed.
|cFFFFCC00*|r It will also autocomplete all names in your BlackBookup.]=] ] = [=[|cFFFFCC00*|r Ce module affichera vos contacts, vos amis, vos guild mates, vos rerolls ainsi que les 10 dernières personnes contactées.
|cFFFFCC00*|r Il remplira également automatiquement tous les noms présents dans votre BlackBookup.]=]
L["Choose"] = "Choisir"
...
L["Part %d"] = "Partie %d"
L["Please post bugs or suggestions at the wowace forums thread at |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. When posting bugs, indicate your locale and Postalup's version number v%s."] = "Merci de signaler les bogues ou de faire part de vos suggestions sur le sujet du forum WoWAce dédié à Postalup : |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. Lors du signalement d'un bogue, indiquez la langue de votre jeu ainsi que le numéro de version de Postalup v%s."
...
L["TradeBlockup"] = "TradeBlockup"
L["Use Postalup's auto-complete"] = "Utiliser l'auto-complétion de Postalup"
...
local L = AL3:NewLocale("Postalup", "koKR")
if L then
...
L[ [=[|cFFFFCC00*|r This module will list your contacts, friends, guild mates, alts and track the last 10 people you mailed.
|cFFFFCC00*|r It will also autocomplete all names in your BlackBookup.]=] ] = [=[|cFFFFCC00*|r 이 모듈은 당신의 접속 목록, 친구, 길드, 내 캐릭터 등 마지막 10명의 인원만 기억 됩니다.
...
L["Part %d"] = "부분 %d"
L["Please post bugs or suggestions at the wowace forums thread at |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. When posting bugs, indicate your locale and Postalup's version number v%s."] = "|cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r.wowace wowace 포럼에서 보다 나은 제안이나 버그 제보를 할수 있습니다.버그 제보시, 귀하의 지역 언어와 버전 번호(v%s)를 알려 주십시오."
...
L["TradeBlockup"] = "거래 불가"
L["Use Postalup's auto-complete"] = "Postalup의 자동완성 기능 사용"
...
local L = AL3:NewLocale("Postalup", "ruRU")
if L then
...
|cFFFFCC00*|r Отключите Детальный режим для прекращения спама в чате при открытии почты.]=]
L[ [=[|cFFFFCC00*|r This module will list your contacts, friends, guild mates, alts and track the last 10 people you mailed.
|cFFFFCC00*|r It will also autocomplete all names in your BlackBookup.]=] ] = [=[|cFFFFCC00*|r Этот модуль будет выводить список ваших контактов, друзей, товарищей гильдии, альтов и отслеживать последних 10 людей, которым вы отправили почту.
...
L["Part %d"] = "Часть %d"
L["Please post bugs or suggestions at the wowace forums thread at |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. When posting bugs, indicate your locale and Postalup's version number v%s."] = "Пожалуйста, сообщите об ошибках или предложениях на форуме wowace |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. Во время отправки ошибки, сообщите язык вашего клиента и номер версии Postalupа v%s."
...
L["TradeBlockup"] = "Блокировать торговлю"
L["Use Postalup's auto-complete"] = "Авто-завершение использования Postalup'а."
...
local L = AL3:NewLocale("Postalup", "zhCN")
if L then
...
L[ [=[|cFFFFCC00*|r This module will list your contacts, friends, guild mates, alts and track the last 10 people you mailed.
|cFFFFCC00*|r It will also autocomplete all names in your BlackBookup.]=] ] = [=[|cFFFFCC00*|r该模块将列出你所有的联系人、好友、公会成员、小号和你最近发送邮件的10个人。
...
L["Part %d"] = "第 %d 组"
L["Please post bugs or suggestions at the wowace forums thread at |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. When posting bugs, indicate your locale and Postalup's version number v%s."] = "请到Wowace的论坛|cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r报告Bug或者提交建议。报告Bug时请说明Postalup的版本 v%s。"
...
L["TradeBlockup"] = "阻止交易"
L["Use Postalup's auto-complete"] = "使用 Postalup 的自动完成"
L["Verbose mode"] = "消息模式"
L["Wireup"] = "填充标题"
...
local L = AL3:NewLocale("Postalup", "zhTW")
if L then
...
|cFFFFCC00*|r 關閉 消息模式 選項來停止當開啟信件時在聊天框的洗頻。]=]
L[ [=[|cFFFFCC00*|r This module will list your contacts, friends, guild mates, alts and track the last 10 people you mailed.
|cFFFFCC00*|r It will also autocomplete all names in your BlackBookup.]=] ] = [=[|cFFFFCC00*|r 此模組將您的聯絡人名單，朋友，公會隊友，分身，並追踪過去您曾郵寄的10人。
...
L["Part %d"] = "分組%d"
L["Please post bugs or suggestions at the wowace forums thread at |cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. When posting bugs, indicate your locale and Postalup's version number v%s."] = "如要回報錯誤或建議請往wowace論壇|cFF00FFFFhttp://forums.wowace.com/showthread.php?t=3909|r. 發帖時，說明你的語系和Postalup的版本編號 v%s."
...
L["TradeBlockup"] = "拒絕交易"
L["Use Postalup's auto-complete"] = "使用Postalup的自動完成"
L["Verbose mode"] = "消息模式"
L["Wireup"] = "自動填寫金額"
